...
)) { (data: ApolloStuff.TrendingArtistsListQuery.Data) -> TrendingArtistsList in
...
)) { (data: ApolloStuff.ArtistDetailViewQuery.Data) -> ArtistDetailView in
...
)) { (data: ApolloStuff.AlbumDetailViewQuery.Data) -> AlbumDetailView in
